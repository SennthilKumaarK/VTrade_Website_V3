...
(function() {
   ...
   * social-sidebar
   */
  let socialsidebar = select('#social-sidebar')
  if (socialsidebar) {
    ...
    window.addEventListener('load', togglesocialsidebar)
    onscroll(document, togglesocialsidebar)
  }
  ...
  window.addEventListener('load', () => {
    ...
    window.addEventListener('load', () => {
        //alert('test');
    let portfolioContainer = select('.category-container');
    if (portfolioContainer) {
      let portfolioIsotope = new Isotope(portfolioContainer, {
        itemSelector: '.portfolio-item'
      });
